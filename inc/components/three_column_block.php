...
<section class="three-column-block__wrapper padding--<?php echo ($verticalPadding) ?>">
  <div class="three-column-block">
    
    <?php if ($heading) : ?>
      <h2 class="three-column-block__heading">
        <?php echo esc_html($heading); ?>
      </h2>
    <?php endif; ?>

    <?php if ($description) : ?>
      <div class="three-column-block__description">
      ...
      <div class="three-column-block__items">
        ...
        ?>
          <div class="three-column-block__item">
            ...
            <?php if ($itemHeading) : ?>
              <h3 class="three-column-block__item-heading">
                <?php echo esc_html($itemHeading); ?>
              </h3>
            <?php endif; ?>

            <?php if ($itemDescription) : ?>
              <p class="three-column-block__item-description">
